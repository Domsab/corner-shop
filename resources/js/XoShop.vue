      ...
      <div class="flex flex-col border-b border-gray-200 lg:border-0">
        ...
        <div class="relative">
          ...
          <div class="relative bg-gray-100 lg:bg-transparent">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:grid lg:grid-cols-2">
      ...
      <section aria-labelledby="trending-heading" class="bg-white">
        <div class="py-16 sm:py-24 lg:max-w-7xl lg:mx-auto lg:py-32 lg:px-8">
          <div class="flex items-center justify-between px-4 sm:px-6 lg:px-0">
            ...
            <a href="#" class="hidden text-sm font-semibold text-indigo-600 sm:block hover:text-indigo-500">See everything<span aria-hidden="true"> &rarr;</span></a>
          </div>

          <div class="relative mt-8">
            <div class="relative w-full overflow-x-auto">
              <ul role="list" class="inline-flex mx-4 space-x-8 sm:mx-6 lg:mx-0 lg:space-x-0 lg:grid lg:grid-cols-4 lg:gap-x-8">
                <li v-for="product in trendingProducts" :key="product.id" class="inline-flex flex-col w-64 text-center lg:w-auto">
                  <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1">
      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="border-t border-gray-200">
          <div class="pt-16 pb-20">
            ...
            <div class="max-w-5xl mx-auto mt-16 xl:grid xl:grid-cols-2 xl:gap-8">
          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
            <div class="flex items-center p-6 bg-gray-100 rounded-lg sm:p-10">
              <div class="max-w-sm mx-auto">
                ...
                <form class="mt-4 sm:mt-6 sm:flex">
                  ...
                  <div class="mt-3 sm:flex-shrink-0 sm:mt-0 sm:ml-4">
                    <button type="submit" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-indigo-500">Sign up</button>
                  </div>
                </form>
              </div>
            </div>
            ...
            <div class="relative flex items-center px-6 py-12 mt-6 sm:py-16 sm:px-10 lg:mt-0">
              <div class="absolute inset-0 overflow-hidden rounded-lg">
                <img src="https://tailwindui.com/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt="" class="object-cover object-center w-full h-full filter saturate-0" />
          ...
          <div class="flex items-center justify-center mt-4 md:mt-0">
            ...
            <div class="pl-6 ml-6 border-l border-gray-200">
              <a href="#" class="flex items-center text-gray-500 hover:text-gray-600">
                <img src="https://tailwindui.com/img/flags/flag-canada.svg" alt="" class="flex-shrink-0 w-5 h-auto" />
