    ...
    <main class="flex-1">
        ...
        >
            ...
            <template #body>
                ...
                <div v-else>
                    <div v-if="modal.action === 'department' || 'categories'">
                        <div class="grid grid-cols-4 gap-6 mt-6">
                            <div class="col-span-3">
                                <label
                                    for="last-name"
                    ...
                    <div v-if="modal.action === 'categories'">
                        <div class="grid grid-cols-4 gap-6 mt-6">
                            <div class="col-span-4">
                                <label
                                    for="cover-photo"
                                    class="block pb-2 text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"
                                >
                                    Category Image
                                </label>
                                <div class="col-span-4 mt-1 sm:mt-0">
                                    <div
...
export default {
    ...
    methods: {
        showDepartmentModal() {
            ...
            this.modal.labels.confirm_btn = "Create Department";

            this.modal.show = true;
        },

        showEditDepartmentModal() {
            this.form = cloneDeep(this.department);

            this.modal.action = "department";
            this.modal.labels.header = `Edit ${this.department.name} Department`;
        ...
        showDeleteModal() {
            ...
            this.modal.labels.header = `Delete ${this.department.name} Department`;
            this.modal.labels.content =
                "Are you sure? You will also delete any associated categories. This can not be undone.";
            this.modal.labels.confirm_btn = `Delete ${this.department.name}`;
        ...
        showCategoryModal() {
            ...
            this.modal.labels.header = `Create Category in '${this.department.name}'`;
        ...
        showSubCategoryModal(category) {
            this.modal.labels.header = `Create Sub Category for '${category.name}' in '${this.department.name}'`;
            this.modal.action = "categories";
        ...
        save() {
            console.log(
                `/dashboard/${this.modal.action}/${this.form.id}`,
                this.form
            );
                ...
                .then((response) => {
                    ...
                    const department =
                        this.modal.action === "department"
                            ...
                            : this.departments.find(
                                  (item) => item.id === this.department.id
                              );
        ...
        remove(action) {
            axios
                .delete(
                    `/dashboard/${this.action}/${this.form.id}`,
