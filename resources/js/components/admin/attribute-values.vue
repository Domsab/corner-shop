...
export default {
    ...
    methods: {
        ...
        get() {
            axios.post('/admin/attributes/values/get', {id: this.attributeData.id})
                .then ( response => {
        ...
        store() {
            axios.post('/admin/attributes/values/store', this.form.store)
                .then ( response => {
                    this.attributeValues = response.data.data;
                    console.log('get values', this.attributeValues);
                })
        ...
        update() {
            axios.post('/admin/attributes/values/update', this.form.update )
                .then ( response => {
                    this.attributeValues = response.data.data;
                    console.log('get values', this.attributeValues);
                })
